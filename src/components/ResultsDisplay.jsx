...
export default function ResultsDisplay({ results, jobTitle }) {
                ...
                <tr key={index} className={candidate.error ? "bg-red-50" : index % 2 === 0 ? "bg-white" : "bg-gray-50"}>
                  ...
                  {candidate.error ? (
                    ...
                    <>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm font-medium text-gray-900">{candidate.analysis.totalScore}/10</div>
                      </td>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="pt-4 border-t border-gray-200">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-lg font-bold text-black">{candidate.analysis.totalScore}/10</span>
                      </div>
                    </div>
                  </div>
                )}
